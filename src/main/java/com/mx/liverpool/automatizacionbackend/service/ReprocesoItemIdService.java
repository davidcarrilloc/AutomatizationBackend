...
@Log4j2
public class ReprocesoItemIdService {
    private final ReprocesoService reprocesoService;
    private final ObjectMapper objectMapper;

    public List<ReprocesoResult> reprocesar(List<ReprocesoItemIdRow> filas) {
        return reprocesoService.reprocesar(filas, ReprocesoItemIdRow::getRemision, this::preparar);
    }

    private ReprocesoService.Preparado preparar(ReprocesoItemIdRow fila) {
        try {
    ...
    static JsonNode nodoItemId(String itemId) {
